...
export default defineConfig({
  ...
  description:
    "Owu Social 是去中心化社交媒体的一部分，提供 GoToSocial 等十余项社交媒体服务。",
  lang: "zh-CN",
  cleanUrls: true,
  lastUpdated: true,
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Owu Holos", link: "/services/holos" },
        ],
      },
      {
        text: "其他",
    ...
    footer: {
      message:
        '本页面内容采用 <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh">CC BY-NC-SA 4.0</a> 协议授权',
